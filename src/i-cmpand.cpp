...
struct CmpAndGroup: KM10 {
  InstructionResult doCAI() { return iNormal; }
  ...
  InstructionResult doCAIA() { return iSkip; }
  ...
  InstructionResult doCAM() { return iNormal; }
  ...
  InstructionResult doCAMA() { (void) memGet(); return iSkip; }
